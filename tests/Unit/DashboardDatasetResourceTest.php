...
class DashboardDatasetResourceTest extends TestCase
{
    ...
    public function test_resource_maps_dataset_with_items_sorted_by_sort_order(): void
    {
        ...
        $resolved = DashboardDatasetResource::collection([$dataset->load('items')])->resolve();
